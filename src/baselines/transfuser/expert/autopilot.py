...
from baselines.transfuser.expert.nav_planner import PIDController, RoutePlanner, interpolate_trajectory

SAVE_PATH = os.environ.get('SAVE_PATH', None)
ROUTES = os.environ['ROUTES']
DEBUG_CHALLENGE = os.environ['DEBUG_CHALLENGE']
...
class AutoPilot(AgentSuppressPrintMixin, autonomous_agent.AutonomousAgent):
    def setup(self, path_to_conf_file):
        ...
        # Configuration
        self.visualize = int(DEBUG_CHALLENGE)
        ...
        if SAVE_PATH is not None:
            ...
            string = pathlib.Path(ROUTES).stem + '_'
