...
from carla_tools.agent_utils import AgentSuppressPrintMixin
from leaderboard.autoagents import autonomous_agent
from omegaconf import OmegaConf

from baselines.tcp.expert.criteria import run_stop_sign
from baselines.tcp.expert.obs_manager.birdview.chauffeurnet import ObsManager
from baselines.tcp.expert.utils.config_utils import load_entry_point
import baselines.tcp.expert.utils.transforms as trans_utils
from baselines.tcp.expert.utils.traffic_light import TrafficLightHandler

from srunner.scenariomanager.carla_data_provider import CarlaDataProvider
from leaderboard.utils.route_manipulation import downsample_route
from agents.navigation.local_planner import RoadOption

from baselines.tcp.planner import RoutePlanner
...
class ROACHAgent(AgentSuppressPrintMixin, autonomous_agent.AutonomousAgent):
    def setup(self, path_to_conf_file, ckpt=pathlib.Path(__file__).parent / "log/ckpt_11833344.pth"):
        ...
        self.disable_safety = cfg.get("disable_safety", False)
    ...
    def run_step(self, input_data, timestamp):
        ...
        ego_pos = self._get_position(tick_data)

        near_node, near_command = self._waypoint_planner.run_step(ego_pos)
        far_node, far_command = self._command_planner.run_step(ego_pos)
        ...
        if should_brake and not self.disable_safety:
    ...
    def get_target_gps(self, gps, compass):
        ...
        def gps_to_location(_gps):
            ...
            xy = (_gps[:2] - self._command_planner.mean) * self._command_planner.scale
            location.x = xy[0]
            location.y = -xy[1]
            return location
