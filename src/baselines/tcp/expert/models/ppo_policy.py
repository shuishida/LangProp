...
class PpoPolicy(nn.Module):
    ...
    def __init__(self,
        ...
        features_extractor_entry_point = features_extractor_entry_point.replace("agents.rl_birdview", "baselines.tcp.expert")
        ...
        distribution_entry_point = distribution_entry_point.replace("agents.rl_birdview", "baselines.tcp.expert")
